...
[![Discord beitreten](https://img.shields.io/discord/1229378372141056010?label=Discord&logo=discord&logoColor=white)](https://discord.gg/c9uGs3cFXr) [![X (ehemals Twitter) folgen](https://img.shields.io/twitter/follow/clodex_xyz)](https://x.com/clodex_xyz)
...
**Clodex Agentic IDE** ist eine Open-Source-Agentic-IDE für Entwickler:innen mit integriertem Coding-Agenten.
...
Lade Clodex Agentic IDE von [clodex.xyz](https://clodex.xyz) herunter und folge der kurzen Einführung zur Einrichtung deines Kontos.
...
Verbinde eines der folgenden Abos mit einem einzigen API-Schlüssel und erhalte Zugriff auf alle Modelle des jeweiligen Anbieters direkt in Clodex Agentic IDE:
...
Für maximale Einfachheit und sofortigen Zugriff auf eine große Modellbibliothek kannst du einfach einen Clodex Account erstellen.
...
Clodex Agentic IDE wird von der Clodex Labs entwickelt und unter der AGPLv3-Lizenz angeboten.

Weitere Informationen zum Lizenzmodell findest du in den [FAQ zu den GNU-Lizenzen](https://www.gnu.org/licenses/gpl-faq.html).

Für Anwendungsfälle, die außerhalb des von der AGPLv3-Lizenz erlaubten Rahmens liegen, kannst du uns gerne [kontaktieren](mailto:sales@clodex.xyz).

## Probleme melden

Eröffne gerne ein [Issue](https://github.com/clodex/clodex-agentic-ide/issues/new), wenn du einen Fehler gefunden hast oder eine neue Idee hast.

## Community & Support

- [Unserem Discord beitreten](https://discord.gg/c9uGs3cFXr)
- Ein [Issue auf GitHub eröffnen](https://github.com/clodex/clodex-agentic-ide/issues/new) für Entwickler:innensupport.
