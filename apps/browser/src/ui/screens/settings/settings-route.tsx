...
export const SETTINGS_NAV_GROUPS: SettingsNavGroup[] = [
  {
    ...
    items: [
      ...
      {
        section: 'agent-os',
        icon: <CpuIcon className="size-4 shrink-0" />,
      },
      {
        section: 'network-egress',
        icon: <ShieldCheckIcon className="size-4 shrink-0" />,
        featureGate: 'egress-control-center',
      },
      {
        section: 'automations',
        icon: <CalendarClockIcon className="size-4 shrink-0" />,
      },
      {
        section: 'memory',
      ...
      },
      {
        ...
        icon: <ServerCogIcon className="size-4 shrink-0" />,
      },
      {
        section: 'plugins',
      ...
      {
        section: 'mcp',
        icon: <CloudCogIcon className="size-4 shrink-0" />,
      },
    ],
  },
  {
