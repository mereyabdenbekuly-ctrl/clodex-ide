...
import {
  GetFileSkeletonToolPart,
  GetSymbolBodyToolPart,
  SearchProjectSymbolsToolPart,
} from './code-intel';
...
export function isReadOnlyToolPart(
  ...
  return (
    ...
    part.type === 'tool-read' ||
    part.type === 'tool-searchProjectSymbols' ||
    part.type === 'tool-getFileSkeleton' ||
    part.type === 'tool-getSymbolBody' ||
    part.type === 'tool-ls' ||
