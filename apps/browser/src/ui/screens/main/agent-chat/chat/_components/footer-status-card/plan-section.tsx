...
import type { PlanTask, TaskGroup } from '@clodex/agent-core/plans';
...
export interface PlanSectionProps {
  ...
  onImplement: (promptOverride?: string) => void;
