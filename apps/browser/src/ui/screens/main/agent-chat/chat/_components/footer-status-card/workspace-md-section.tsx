...
import { IconMediaStopFill18 } from '@clodex/icons';
...
function getStatusText(history: AgentMessage[]): string {
  const INITIALIZING_TEXT = 'Initializing .clodex/WORKSPACE.md...';
            ...
            <Tooltip>
              <TooltipTrigger>
                <span className="truncate font-normal text-muted-foreground">
                  ...
                  {errorMessage || 'Failed to generate .clodex/WORKSPACE.md'}
                </span>
              </TooltipTrigger>
              <TooltipContent>
                {errorMessage || 'Failed to generate .clodex/WORKSPACE.md'}
          ...
          <>
            <div className="flex min-w-0 shrink flex-row items-center gap-1 truncate">
              ...
              <Tooltip>
                ...
                <TooltipContent>.clodex/WORKSPACE.md</TooltipContent>
              </Tooltip>
              <span className="truncate font-normal text-muted-foreground">
                generated
              </span>
