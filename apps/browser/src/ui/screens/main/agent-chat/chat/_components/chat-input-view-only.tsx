  ...
  if (!tipTapContent) return null;
    ...
    return (
      <div
        ref={setContainer}
        className={cn(
          'mask-alpha max-h-43.5 w-full overflow-y-hidden text-[length:var(--codex-chat-font-size)] leading-6',
          className,
        )}
        style={maskStyle}
      >
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'h-full w-full text-[length:var(--codex-chat-font-size)] text-foreground leading-6',
