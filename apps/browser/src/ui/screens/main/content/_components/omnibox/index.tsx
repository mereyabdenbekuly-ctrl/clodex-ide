...
export const Omnibox = ({
  ...
  const displayedTabUrl = tab?.url === 'clodex://internal/home' ? '' : tab?.url;
  ...
  const shouldShowBreadcrumbs =
    displayedTabUrl?.startsWith('clodex://internal/');
  ...
  // above tab webcontents. Only force clodex-ui to foreground on open.
                ...
                <div className="mt-2 flex w-full items-center justify-end gap-4 rounded-md px-1 py-1 text-primary-solid text-sm">
                  <span>
                    ...
                    <strong className="font-medium">
                      Set clodex as your default browser!
                    </strong>
                  </span>
