...
export function Sidebar() {
  ...
  return (
    <ResizablePanel
      ...
      className={`${SIDEBAR_PANEL_CLASS_NAME} codex-sidebar-surface border-token-border-light border-r data-[panel-size='0.0']:min-w-0`}
    >
      <SidebarTitlebarRow absolute />
      {!collapsed && (
        <div
          className="flex h-full flex-col items-stretch px-2.5 pb-2.5"
          style={{ paddingTop: (TITLEBAR_HEIGHT + 10) * counterScale }}
        >
          <AgentsList />
