  ...
  return (
    <div
      className={cn(
        ...
        'justify-start rounded-lg pr-3.5 pl-2 text-token-text-secondary hover:bg-token-list-hover-background',
      )}
    >
  ...
  forwardRef<HTMLDivElement, AgentCardProps>(function AgentCard(
    ...
    return (
      <div
        ...
        className={cn(
          buttonVariants({ variant: 'ghost', size: 'sm' }),
          'group/card relative justify-start gap-1 rounded-lg pr-3.5 pl-2 text-start text-token-text-secondary transition-[background-color,color,box-shadow] hover:bg-token-list-hover-background hover:text-token-text-primary',
          isPreviewActive &&
            !isActive &&
      ...
      >
        ...
        {type === AgentTypes.MAGUS && !isEditing ? (
          <span className="shrink-0 rounded bg-primary-solid/15 px-1 py-px font-medium text-[10px] text-primary-solid leading-none">
            Magus
          </span>
        ) : null}
