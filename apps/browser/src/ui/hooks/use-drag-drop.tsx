...
export function useDragDrop(options: UseDragDropOptions): UseDragDropReturn {
  ...
  const handleDragEnter = useCallback((e: React.DragEvent) => {
    ...
    if (
      ...
      types.includes('application/x-clodex-file-path') ||
      types.includes('application/x-clodex-file-paths')
    )
      setIsDragOver(true);
  }, []);
  ...
  const handleDrop = useCallback(
    async (e: React.DragEvent) => {
      ...
      const draggedWorkspacePaths = e.dataTransfer.getData(
        'application/x-clodex-file-paths',
      );
      ...
      const draggedWorkspacePath = e.dataTransfer.getData(
        'application/x-clodex-file-path',
      );
