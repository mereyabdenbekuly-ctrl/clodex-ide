...
import {
  ...
  isAutoUpdateEnabledForDistribution,
...
describe('auto-update config', () => {
  ...
  it('hard-disables every update channel for community distributions', () => {
    expect(isAutoUpdateEnabledForDistribution('official')).toBe(true);
