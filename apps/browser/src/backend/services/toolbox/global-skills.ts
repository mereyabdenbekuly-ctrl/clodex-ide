...
/**
 * Return all known global skill mount descriptors (clodex, agents,
 * Agent OS, codex, claude). This is the canonical list — every other
  ...
  return [
    {
      ...
      absolutePath: path.resolve(home, '.clodex', 'skills'),
    },
    {
    ...
    {
      prefix: 'globalskills-agent-os',
      absolutePath: getInstalledSkillsDir(),
    },
    {
 ...
 *
 * The built-in `globalskills-sw`, `globalskills-agents`, and
 * `globalskills-agent-os` mounts are always enabled. External mounts (`globalskills-codex`,
