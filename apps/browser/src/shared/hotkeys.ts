...
export enum HotkeyActions {
  ...
  OPEN_QUICK_TASK = 'open_quick_task',
  ...
  TOGGLE_SWARM_SIDEBAR = 'toggle_swarm_sidebar',
...
export const hotkeyDefinitions: Record<HotkeyActions, HotkeyDefinition> = {
  ...
  [HotkeyActions.TOGGLE_DICTATION]: {
    accelerator: 'Mod+Shift+Space',
    captureDominantly: true,
  },
  ...
  [HotkeyActions.TOGGLE_SWARM_SIDEBAR]: {
