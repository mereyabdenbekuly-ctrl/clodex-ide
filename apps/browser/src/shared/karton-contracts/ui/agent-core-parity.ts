/**
 * Compile-time parity assertions between `@clodex/agent-core`'s
...
} from '@clodex/agent-core/store';
import type { AgentState as CoreAgentState } from '@clodex/agent-core/types/agent';
