...
type NupkgRouteParams = DownloadRouteParams & {
  filename: string;
};

type LinuxDownloadRouteParams = DownloadRouteParams & {
  format: string;
};
...
router.get(
  ...
  async (req: Request<UpdateRouteParams>, res: Response) => {
...
router.get(
  ...
  async (req: Request<NupkgRouteParams>, res: Response) => {
...
router.get(
  ...
  async (req: Request<DownloadRouteParams>, res: Response) => {
...
router.get(
  ...
  async (req: Request<LinuxDownloadRouteParams>, res: Response) => {
