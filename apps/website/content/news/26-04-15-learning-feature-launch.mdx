---
title: "Introducing Learning to clodex"
author: clodex team
type: releases
description: "The new Learn feature in clodex helps you turn useful guidance into reusable skills without giving up control over what the agent remembers."
...
<div className="my-8 overflow-hidden rounded-2xl border border-border bg-black shadow-sm">
  <div className="aspect-video w-full">
    <iframe
      ...
      title="clodex Learn launch video"
...
## Introducing Learn in clodex

We are introducing **Learn**, a new feature in clodex for turning useful guidance into something your agent can reuse.
