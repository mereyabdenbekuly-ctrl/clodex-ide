---
title: "How Smart Approvals Work in clodex"
author: clodex team
type: technical
...
Until now, shell tool calls in clodex were either guarded by an aggressive "Always ask" mode or a fast but dangerous "Always allow" mode.
...
Clodex now supports three approval modes:
...
If you want to try it, open an agent in clodex and switch the approval mode from **Always ask** to **Smart approval**.