...
author: clodex team
type: releases
description: "Last week’s clodex updates focussed on everyday product improvements: `/preview` for quick experiments, safer agent deletion, a more responsive UI, and better Windows reliability."
...
This was a week of making clodex easier to trust: quicker ways to try ideas, fewer destructive mistakes, a faster UI, and fewer platform-specific failures.