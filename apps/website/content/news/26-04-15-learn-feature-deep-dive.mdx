...
author: clodex team
type: technical
description: "A closer look at the new Learn command in clodex, why skills matter, what makes them hard to maintain, and why controlled learning is a better starting point for agents."
...
The idea did not start with clodex. The standard was originally proposed by Anthropic, and it has since grown into a more open and extensible format.
...
There is also a safety problem. Skills can ship scripts, and there is no good shared standard yet for how those scripts should be reviewed, executed, or trusted. That is one reason clodex does not support direct execution of scripts inside skills today.
...
If you want the simpler product overview first, read [Learning Arrives in clodex](/news/learning-feature-launch).

To make workflows more efficient while keeping control in the hands of the user, clodex introduces a built-in Learn skill.

That skill powers the **`/Learn`** command in clodex. The name is direct: the agent learns new skills.
