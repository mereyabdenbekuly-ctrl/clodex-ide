...
You'll work on the **clodex IDE**, our open-source platform for managing coding agents in the age of agentic software development. Your mission is simple: build the go-to agentic IDE developers will reach for when working with AI.
