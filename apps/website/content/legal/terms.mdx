...
- Changed name of company from "tiq UG (haftungsbeschränkt)" to "clodex GmbH".

### Preamble

These Terms of Service ("Terms") govern the use of the services offered by clodex GmbH, located at Obernstraße 50, 33602 Bielefeld, Germany, registered with the local court (Amtsgericht) of Bielefeld under HRB 45829 ("we," "us," or "clodex").
...
1.1. clodex provides a cloud-based AI agent designed to assist users in creating and editing frontends for web applications (the "Service"). The Service is delivered via an IDE extension or a dedicated application that communicates with clodex's cloud infrastructure.
...
1.4. We do not guarantee any specific service availability (uptime). Support is provided on a best-effort basis via email to support@clodex.io or through our Discord channel, without guaranteed response times.
...
3.1. **Our Rights:** All rights to the Service itself, including the underlying software, AI models, user interfaces, and all related technology, are the exclusive property of clodex or our licensors. We grant the User a limited, non-exclusive, non-transferable right to use the Service in accordance with these Terms for the duration of the contract.
...
5.7. **Refunds:** Users do not have a general right to a refund. If the User believes they are entitled to a refund due to demonstrable wrongdoing on our part or other issues preventing use of the Service, they may contact us at **support@clodex.io**. We will review such requests at our sole discretion.
...
6.2. It is strictly prohibited to:
    ...
    b) Overload, disrupt, or compromise the security of clodex's systems, networks, or API (e.g., through spamming, viruses, DoS attacks).
...
8.4. Any further liability of clodex is excluded. These limitations of liability also apply in favor of our legal representatives and agents.
