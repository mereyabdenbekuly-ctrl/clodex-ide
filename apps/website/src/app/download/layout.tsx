...
export const metadata: Metadata = {
  title: 'Download CLODEx Community Observed 21',
  description:
    'Download the verified CLODEx Community Observed 21 Technical Preview for macOS, Windows, and Linux, with checksums and release evidence.',
  openGraph: {
    title: 'Download CLODEx Community Observed 21',
    description:
