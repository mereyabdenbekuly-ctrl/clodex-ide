...
export default async function DownloadPage({
  ...
  const copy = isRussian
    ? {
        ...
        readyTitle: 'Скачать CLODEx Community Observed 15',
        unavailableTitle: 'Ссылки на сборку недоступны',
        readyDescription:
          'Community Observed 15 прошла проверку Free/managed boundary и packaged bytes. Выберите пакет для своей платформы и проверьте его перед установкой.',
    ...
    : {
        ...
        readyTitle: 'Download CLODEx Community Observed 15',
        unavailableTitle: 'Build links are unavailable',
        readyDescription:
          'Community Observed 15 passed the Free/managed boundary and packaged-byte gates. Choose the package for your platform and verify it before installation.',
        unavailableDescription:
