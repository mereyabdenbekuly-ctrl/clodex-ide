...
const ENTERPRISE_FEATURES = [
  ...
  'Access to clodex Cloud Inference and clodex Cloud Inference EU',
  'SSO with OIDC and SAML',
  'Provisioning with SCIM',
  'Optional self-hosting of the clodex Cloud',
];
      ...
      <div className="mt-16 flex flex-col gap-10 md:flex-row md:gap-16">
        ...
        <div className="flex-1 space-y-6">
          <h2 className="font-medium text-foreground text-lg">
            Leverage AI driven development in your organization with clodex.
          </h2>
          ...
          <a
            href="https://docs.clodex.io/enterprise"
          ...
          >
            Learn more about clodex for Enterprises
