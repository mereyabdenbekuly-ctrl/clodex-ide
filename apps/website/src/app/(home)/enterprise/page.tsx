...
export const metadata: Metadata = {
  title: 'clodex for Enterprises · clodex',
  description:
    'Leverage AI driven development in your organization with clodex. Control, compliance and scale for teams that need it.',
  openGraph: {
    title: 'clodex for Enterprises · clodex',
    description:
      'Leverage AI driven development in your organization with clodex. Control, compliance and scale for teams that need it.',
  ...
  category: 'technology',
  alternates: {
    canonical: 'https://clodex.io/enterprise',
  },
          ...
          <ScrollReveal>
            <div className="mb-6 flex flex-col items-start px-4 text-left md:mb-8">
              <h1 className="mb-4 font-medium text-3xl tracking-tight md:text-5xl">
                <span className="text-foreground">clodex for Enterprises</span>
              </h1>
