...
export const metadata: Metadata = {
  title:
    'An Open-Source IDE & Coding Agent with First-Class MiniMax Support · clodex',
  description:
    'clodex is an open-source IDE and coding agent with first-class support for MiniMax M3, M2.7, and M2. MiniMax M3 is state of the art among open-weight models with native vision, with precise instruction following and a low hallucination rate. Run via clodex Cloud Inference, the MiniMax Token Plan, your own API key, or local inference.',
  openGraph: {
    title:
      'An Open-Source IDE & Coding Agent with First-Class MiniMax Support · clodex',
    description:
  ...
  alternates: {
    canonical: 'https://clodex.io/use-cases/minimax',
  },
  ...
  itemListElement: [
    {
      ...
      position: 1,
      name: 'Home',
      item: 'https://clodex.io/',
    },
    {
      '@type': 'ListItem',
      position: 2,
      name: 'MiniMax',
      item: 'https://clodex.io/use-cases/minimax',
    },
  ],
};
    ...
    <>
            ...
            <ScrollReveal>
              <div className="mt-0 mb-6 flex flex-col items-start px-4 text-left md:mt-2 md:mb-8">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  ...
                  low hallucination rate. clodex gives it a local IDE with a
          ...
          <div className="w-full max-w-4xl px-4">
            <ScrollReveal>
              <div className="prose dark:prose-invert prose-p:my-0 prose-headings:mt-6 prose-headings:mb-4 max-w-none [&>p+p]:mt-5">
                <p>
                  clodex is a local IDE that ships with its own coding agent. It
                  runs on your machine, connects to your development
          ...
          <div className="w-full max-w-4xl px-4">
            <ScrollReveal>
              <div className="prose dark:prose-invert prose-p:my-0 prose-headings:mt-6 prose-headings:mb-4 max-w-none [&>p+p]:mt-5">
                ...
                <p>
                  The clodex agent keeps the early part of the conversation{' '}
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-4xl px-4">
            <ScrollReveal>
              <div className="prose dark:prose-invert prose-p:my-0 prose-headings:mt-6 prose-headings:mb-4 max-w-none [&>p+p]:mt-5">
                <h2 className="font-medium text-foreground text-xl">
                  Use MiniMax through a clodex Account, the MiniMax Token Plan,
                  or local inference
                </h2>
                <p>
                  The default{' '}
                  <Link
                    ...
                    className="text-primary underline-offset-4 hover:underline"
                  >
                    <strong>clodex Cloud Inference</strong>
                  </Link>{' '}
                  is the easiest way to get started: with a clodex Account, you
                  get preconfigured access to MiniMax models alongside a wide
                ...
                <p>
                  ...
                  <a
                    href="https://docs.clodex.io/reference/custom-providers"
                    target="_blank"
                    rel="noreferrer"
                  >
                ...
                <p>
                  clodex does not dictate where you buy inference. You choose
          ...
          <div className="w-full max-w-4xl px-4">
            <ScrollReveal>
              <div className="prose dark:prose-invert prose-p:my-0 prose-headings:mt-6 prose-headings:mb-4 max-w-none [&>p+p]:mt-5">
                ...
                <p>
                  With clodex, this becomes practical. clodex agents can take
                  screenshots of the website you are working on, send them to
                  MiniMax M3, and the model can <em>see</em> what is on screen.
                  The agent can then check visual output, improve designs, and
                  resolve issues that require vision access — without you having
      ...
      <UseCaseFAQ
        items={[
          ...
          {
            question: 'How can I use MiniMax in clodex?',
            plainTextAnswer:
              'You can run MiniMax in clodex using three options: 1. clodex Cloud Inference: With a clodex Account, you get preconfigured access to a wide variety of models including MiniMax M3, MiniMax M2.7, and MiniMax M2 — no keys, configuration, or external subscriptions required. 2. Your API Key: Supply your own MiniMax API key, or use an API aggregator (like OpenRouter or fireworks.ai) to route your queries. 3. Custom Endpoint: Connect clodex to any custom endpoint — including local servers (Ollama, Llama.cpp), on-premise deployments (vLLM), or enterprise inference providers.',
            answer: (
              <>
                <p>You can run MiniMax in clodex using three options:</p>
                <ul className="mt-2 list-disc space-y-2 pl-5">
                  <li>
                    ...
                    : With a clodex Account, you get preconfigured access to a
                    wide variety of models including MiniMax M3, MiniMax M2.7,
                  ...
                  <li>
                    <strong>Custom Endpoint:</strong> Connect clodex to{' '}
          ...
          },
          {
            ...
            plainTextAnswer:
              'The models listed on the clodex home page — MiniMax M3, MiniMax M2.7, and MiniMax M2 — are available out of the box. Beyond those, you can connect any additional MiniMax model that has agentic capabilities through your own API key or inference provider.',
            answer: (
              <>
                <p>
                  The models listed on the clodex home page —{' '}
            ...
            answer: (
              <>
                ...
                <p>
                  ...
                  whenever you like — clodex Cloud Inference, the MiniMax Token
                  Plan, your own API key, or local inference — without losing
                  your work or configuration.
                </p>
              </>
            ),
          },
          {
            question:
              'Can I use fine-tuned or quantized variants of MiniMax models with clodex?',
            plainTextAnswer:
            ...
            answer: (
              <>
                <p>
                  ...
                  <a
                    href="https://docs.clodex.io/reference/custom-models"
                    target="_blank"
                    rel="noreferrer"
                  >
                    custom models docs
          ...
          },
          {
            ...
            plainTextAnswer:
              'Yes. You can configure clodex Agents to use models from any source, including a local setup using Ollama or an on-premise deployment in your own datacenter with setups like vLLM. clodex supports any inference provider option that serves models via one of the popular model access APIs like OpenAI Chat Completions API, OpenResponses API, or Anthropic Messages API. The minimum recommended context size is 150k tokens.',
            answer: (
              <>
                <p>
                  Yes. You can configure clodex Agents to use models from{' '}
                  <em>any</em> source, including a local setup using Ollama or
                  an on-premise deployment in your own datacenter with setups
                  like vLLM.
                </p>
                <p>
                  clodex supports any inference provider option that serves
          ...
          },
          {
            ...
            plainTextAnswer:
              'Yes. clodex offers the option to connect Azure Foundry, AWS Bedrock, and Google Vertex endpoints for enterprise-grade inference. See the clodex enterprise page for more.',
            answer: (
              <>
                <p>
                  Yes. clodex offers the option to connect{' '}
