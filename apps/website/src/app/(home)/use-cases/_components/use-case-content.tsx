          ...
          <ScrollReveal>
            <div className="mt-0 mb-6 flex flex-col items-start px-4 text-left md:mt-2 md:mb-8">
              ...
              <p className="max-w-2xl text-lg text-muted-foreground leading-relaxed">
                clodex is a frontier-grade harness that maximizes the power of{' '}
                {modelName} and serves {modelName} models either via the clodex
                Account, your existing subscriptions or your API keys. Get a
                first class coding experience with {modelName}.
              </p>
              <div className="mt-8">
                <DownloadButtons />
              </div>
