...
export const metadata: Metadata = {
  title:
    'An Open-Source IDE & Coding Agent with First-Class GLM Support · clodex',
  description:
    'clodex is an open-source IDE and coding agent with first-class support for GLM 5.2, 5.1, and 5V-Turbo from Z.AI. Run via clodex Cloud Inference, your own Z.AI API key, or local inference. Near-Claude Opus 4.8 quality at a fraction of the cost.',
  openGraph: {
    title:
      'An Open-Source IDE & Coding Agent with First-Class GLM Support · clodex',
    description:
  ...
  alternates: {
    canonical: 'https://clodex.io/use-cases/glm',
  },
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'GLM',
      item: 'https://clodex.io/use-cases/glm',
    },
  ],
};
    ...
    <>
            ...
            <ScrollReveal>
              <div className="mt-0 mb-6 flex flex-col items-start px-4 text-left md:mt-2 md:mb-8">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  ...
                  lower cost point. clodex gives it a local IDE with a capable
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-4xl px-4">
            <ScrollReveal>
              <div className="prose dark:prose-invert prose-p:my-0 prose-headings:mt-6 prose-headings:mb-4 max-w-none [&>p+p]:mt-5">
                <h2 className="font-medium text-foreground text-xl">
                  Use GLM through a clodex Account, your own endpoint, or local
                  inference
                </h2>
                <p>
                  You can use GLM 5.2 through a clodex Account and start without
          ...
          <div className="w-full max-w-4xl px-4">
            <ScrollReveal>
              <div className="prose dark:prose-invert prose-p:my-0 prose-headings:mt-6 prose-headings:mb-4 max-w-none [&>p+p]:mt-5">
                ...
                <p>
                  The clodex agent compensates for that limitation. The clodex
            ...
            <ScrollReveal delay={300}>
              <div className="prose dark:prose-invert prose-p:my-0 mt-8 max-w-none">
                <p>
                  ...
                  not possible. But even with GLM models, clodex agents are able
                  to understand the role of the image, its format, its file
      ...
      <UseCaseFAQ
        items={[
          ...
          {
            question: 'How can I use GLM in clodex?',
            plainTextAnswer:
              'You can run GLM in clodex using three options: 1. clodex Cloud Inference: With a clodex Account, you get preconfigured access to a wide variety of models including GLM 5.2, GLM 5.1, and GLM 5V-Turbo — no keys, configuration, or external subscriptions required. 2. Your API Key: Supply your own Z.AI API key, or use an API aggregator (like OpenRouter or fireworks.ai) to route your queries. 3. Custom Endpoint: Connect clodex to any custom endpoint — including local servers (Ollama, Llama.cpp), on-premise deployments (vLLM), or enterprise inference providers.',
            answer: (
              <>
                <p>You can run GLM in clodex using three options:</p>
                <ul className="mt-2 list-disc space-y-2 pl-5">
                  <li>
                    ...
                    wide variety of models including GLM 5.2, GLM 5.1, and GLM
          ...
          },
          {
            ...
            plainTextAnswer:
              'The models listed on the clodex home page — GLM 5.2, GLM 5.1, and GLM 5V-Turbo — are available out of the box. Beyond those, you can connect any additional GLM model that has agentic capabilities through your own API key or inference provider.',
            answer: (
              <>
                <p>
          ...
          {
            question: 'Can I use my GLM coding plan with clodex?',
            plainTextAnswer:
              "Yes, but at your own risk. While clodex supports using the GLM coding plan, clodex is not an official partner of Z.AI's coding plan program and cannot guarantee that your access to GLM models through the coding plan API key complies with Z.AI's terms.",
            answer: (
              <>
                <p>
                  Yes, but <strong>at your own risk</strong>. While clodex
                  supports using the GLM coding plan, clodex is{' '}
                  <em>not an official partner</em> of Z.AI&apos;s coding plan
                  program.
                </p>
                <p>
                  clodex cannot guarantee that your access to GLM models through
                  the coding plan API key complies with Z.AI&apos;s terms.
                </p>
              </>
            ),
          },
          {
            question:
              'Can I use fine-tuned or quantized variants of GLM models with clodex?',
            plainTextAnswer:
