...
export const metadata: Metadata = {
  title:
    'An Open-Source IDE & Coding Agent with First-Class DeepSeek Support · clodex',
  description:
    'clodex is an open-source IDE and coding agent with first-class support for DeepSeek V4 Pro and V4 Flash. Run via clodex Cloud Inference, your own API key, or local inference with Ollama — no lock-in.',
  openGraph: {
    title:
      'An Open-Source IDE & Coding Agent with First-Class DeepSeek Support · clodex',
    description:
  ...
  alternates: {
    canonical: 'https://clodex.io/use-cases/deepseek',
  },
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'DeepSeek',
      item: 'https://clodex.io/use-cases/deepseek',
    },
  ],
};
    ...
    <>
            ...
            <ScrollReveal>
              <div className="mt-0 mb-6 flex flex-col items-start px-4 text-left md:mt-2 md:mb-8">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  ...
                  clodex Account, your own API setup, or local inference.
                </p>
                <div className="mt-8">
                  <DownloadButtons />
                </div>
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-4xl px-4">
            <ScrollReveal>
              <div className="prose dark:prose-invert prose-p:my-0 prose-headings:mt-6 prose-headings:mb-4 max-w-none [&>p+p]:mt-5">
                <h2 className="font-medium text-foreground text-xl">
                  Use DeepSeek through a clodex Account, your own endpoint, or
                  local inference
                </h2>
                <p>
                  You can use DeepSeek V4 Flash and V4 Pro through a clodex
          ...
          <div className="w-full max-w-4xl px-4">
            <ScrollReveal>
              <div className="prose dark:prose-invert prose-p:my-0 prose-headings:mt-6 prose-headings:mb-4 max-w-none [&>p+p]:mt-5">
                ...
                <p>
                  The clodex agent however takes a different approach: the
                  clodex file transformation pipeline turns each image into
      ...
      <UseCaseFAQ
        items={[
          ...
          {
            question: 'How can I use DeepSeek in clodex?',
            plainTextAnswer:
              'You can run DeepSeek in clodex using three options: 1. clodex Cloud Inference: With a clodex Account, you get preconfigured access to a wide variety of models including DeepSeek V4 Pro and V4 Flash — no keys, configuration, or external subscriptions required. 2. Your API Key: Supply a DeepSeek API key, or use an API aggregator (like OpenRouter or fireworks.ai) to route your queries. 3. Custom Endpoint: Connect clodex to any custom endpoint — including local servers (Ollama, Llama.cpp), on-premise deployments (vLLM), or enterprise inference providers.',
            answer: (
              <>
                <p>You can run DeepSeek in clodex using three options:</p>
                <ul className="mt-2 list-disc space-y-2 pl-5">
                  <li>
                    ...
                    wide variety of models including DeepSeek V4 Pro and V4
          ...
          },
          {
            ...
            plainTextAnswer:
              'The models listed on the clodex home page — DeepSeek V4 Pro and DeepSeek V4 Flash — are available out of the box. Beyond those, you can connect any additional DeepSeek model that has agentic capabilities through your own API key or inference provider.',
            answer: (
              <>
                <p>
          ...
          {
            question:
              'Can I use fine-tuned or quantized variants of DeepSeek models with clodex?',
            plainTextAnswer:
