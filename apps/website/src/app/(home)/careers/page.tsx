...
export const metadata: Metadata = {
  ...
  category: 'technology',
  alternates: {
    canonical: 'https://clodex.io/careers',
  },
      ...
      <section className="mt-12">
        ...
        <ScrollReveal delay={100}>
          <div className="flex flex-col gap-4 text-base text-muted-foreground">
            <p>
              <strong className="text-foreground">clodex</strong> is building
        ...
        <ScrollReveal>
          <div>
            ...
            <p className="mb-6 text-base text-muted-foreground">
              ...
              background and tell us how you would contribute to clodex.
            </p>
            <a
              href="mailto:career@clodex.io"
