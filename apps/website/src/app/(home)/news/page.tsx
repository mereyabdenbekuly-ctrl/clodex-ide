...
export const metadata: Metadata = {
  title: 'Newsroom · clodex',
  description:
    "Find out what we're up to, what we're thinking, and what we're doing at clodex",
  openGraph: {
    title: 'Newsroom · clodex',
    description:
      "Find out what we're up to, what we're thinking, and what we're doing at clodex",
  ...
  category: 'technology',
  alternates: {
    canonical: 'https://clodex.io/news',
  },
      ...
      <ScrollReveal delay={100}>
        <div className="mb-8 flex w-full flex-wrap items-center justify-between gap-4">
          <div className="flex flex-row gap-4">
            <Link
              href="https://www.ycombinator.com/companies/clodex"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Y Combinator page of clodex"
            ...
            <Link
              href="https://www.linkedin.com/company/clodex-io"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn page of clodex"
            ...
            <Link
              href="https://x.com/clodex_io"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="X page of clodex"
