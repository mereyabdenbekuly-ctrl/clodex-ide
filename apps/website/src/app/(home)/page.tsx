...
const softwareAppJsonLd = {
  ...
  description: readyCommunityRelease
    ? 'Free open-source local-first Agentic IDE for persistent tasks, code, Git, terminal, browser, models, MCP, and review. Community Observed 21 is the current verified Technical Preview.'
...
export const metadata: Metadata = {
  ...
  description:
    'Download the verified CLODEx Community Observed 21 Technical Preview for macOS, Windows, and Linux.',
  openGraph: {
    title: 'One task. Your local engineering workspace. · CLODEx Community',
    description:
      'Free local-first Agentic IDE with the verified Community Observed 21 Technical Preview for macOS, Windows, and Linux.',
    type: 'website',
  },
  twitter: {
    title: 'One task. Your local engineering workspace. · CLODEx Community',
