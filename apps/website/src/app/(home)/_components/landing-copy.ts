...
export const landingCopy = {
  ru: {
    ...
    hero: {
      ...
      description:
        'CLODEx объединяет постоянные задачи, код, Git, терминал, браузер, модели и MCP в одном desktop workspace. Проверенная Community Observed 17 доступна для macOS Apple Silicon и Intel, Windows x64 и Linux x64.',
    ...
    runtime: {
      ...
      description:
        'Community Observed 17 прошла Free/managed boundary и packaged-byte проверки, но Technical Preview не является заявлением о полном hardening или идеальной изоляции. Claims ограничены опубликованным release evidence.',
      layers: [
        {
        ...
        },
        {
          ...
          text: 'Community Observed 17 публикует SHA-256, SBOM, validation manifests и evidence archive для пяти installers.',
          detail:
    ...
    final: {
      ...
      description:
        'Community Observed 17 привязана к точному source commit, build run, checksums и release evidence.',
  ...
  en: {
    ...
    hero: {
      ...
      description:
        'CLODEx brings persistent tasks, code, Git, terminal, browser, models, and MCP into one desktop workspace. Verified Community Observed 17 is available for macOS Apple Silicon and Intel, Windows x64, and Linux x64.',
    ...
    runtime: {
      ...
      description:
        'Community Observed 17 passed the Free/managed boundary and packaged-byte gates, but a Technical Preview is not a claim of complete hardening or perfect isolation. Claims remain limited to the published release evidence.',
      layers: [
        {
          label: 'Local workspace',
        ...
        },
        {
          ...
          text: 'Community Observed 17 publishes SHA-256 checksums, SBOMs, validation manifests, and an evidence archive for five installers.',
          detail:
    ...
    final: {
      ...
      description:
        'Community Observed 17 is pinned to one exact source commit, build run, checksum set, and release-evidence archive.',
      sales: 'Send feedback',
    },
  },
} as const;
