...
| Boundary CI | Public Protocol governance and a synthetic private-firewall reference are implemented; private enforcement is not operating | Independently implement and operate the deny policy in the future secured private repository, retain CI evidence, and keep B3/PV0-G09 open until then |
