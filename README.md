...
```bash
git clone https://github.com/mereyabdenbekuly-ctrl/clodex.git
cd clodex
...
Independent development can be supported with USDT through the network-aware
donation interface on the [Clodex website](https://ide.clodex.xyz/#support).
Always select the matching network before transferring funds.
