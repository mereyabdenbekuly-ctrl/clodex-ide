...
[![Присоединиться в Discord](https://img.shields.io/discord/1229378372141056010?label=Discord&logo=discord&logoColor=white)](https://discord.gg/c9uGs3cFXr) [![Подписаться в X (бывш. Twitter)](https://img.shields.io/twitter/follow/clodex_xyz)](https://x.com/clodex_xyz)
...
**Clodex Agentic IDE** — это агентная IDE с открытым исходным кодом для разработчиков со встроенным агентом-программистом.
...
Скачайте Clodex Agentic IDE с [clodex.xyz](https://clodex.xyz) и следуйте краткому руководству для настройки аккаунта.
...
Подключите любую из следующих подписок с помощью одного API-ключа, чтобы разблокировать все модели, предлагаемые провайдером, напрямую в Clodex Agentic IDE.
...
### Аккаунт Clodex Agentic IDE

Для удобства использования и немедленного доступа к большой библиотеке моделей просто создайте аккаунт Clodex Agentic IDE.
...
Clodex Agentic IDE разрабатывается Clodex Labs и предлагается под лицензией AGPLv3.
...
Для сценариев использования, выходящих за рамки того, что разрешено лицензией AGPLv3, свяжитесь с нами по [электронной почте](mailto:sales@clodex.xyz).

## Проблемы

Не стесняйтесь [открыть issue](https://github.com/clodex/clodex-agentic-ide/issues/new), если вы нашли баг или у вас есть свежая идея.

## Сообщество и поддержка

- [Присоединяйтесь к нашему Discord](https://discord.gg/c9uGs3cFXr)
- Откройте [issue на GitHub](https://github.com/clodex/clodex-agentic-ide/issues/new) для технической поддержки.
