...
[![Discordに参加](https://img.shields.io/discord/1229378372141056010?label=Discord&logo=discord&logoColor=white)](https://discord.gg/c9uGs3cFXr) [![X (旧Twitter) フォロー](https://img.shields.io/twitter/follow/clodex_xyz)](https://x.com/clodex_xyz)

![Clodex Agentic IDE デモ](https://raw.githubusercontent.com/clodex/clodex-agentic-ide/main/apps/website/src/app/(home)/_components/feature-images/full-demo-dark.png)

## プロジェクトについて

**Clodex Agentic IDE** は、コーディングエージェントを内蔵した、開発者向けのオープンソース Agentic IDE です。
...
[clodex.xyz](https://clodex.xyz) から Clodex Agentic IDE をダウンロードし、短いオンボーディングガイドに従ってアカウントを設定してください。
...
以下のいずれかのサブスクリプションをAPIキー1つで接続するだけで、そのプロバイダーが提供する全モデルを Clodex Agentic IDE 内で利用できます。
...
### Clodex Agentic IDE アカウント

手軽に始めて豊富なモデルライブラリにすぐアクセスしたい場合は、Clodex Agentic IDE アカウントを作成するだけでOKです。
...
Clodex Agentic IDE は Clodex Labs が開発し、AGPLv3 ライセンスのもとで提供されています。

ライセンスモデルの詳細については、[GNU ライセンスに関するFAQ](https://www.gnu.org/licenses/gpl-faq.html) をご覧ください。

AGPLv3 ライセンスの範囲外での使用については、[お問い合わせ](mailto:sales@clodex.xyz)ください。

## 問題報告

バグを発見したり、新しいアイデアがあれば、[Issueを開いて](https://github.com/clodex/clodex-agentic-ide/issues/new)ください。

## コミュニティ & サポート

- [Discordに参加する](https://discord.gg/c9uGs3cFXr)
- 開発サポートは [GitHub の Issue](https://github.com/clodex/clodex-agentic-ide/issues/new) からどうぞ。
