...
```bash
pnpm add -D @clodex/tailwindcss-color-modifiers
# or
npm install -D @clodex/tailwindcss-color-modifiers
# or
yarn add -D @clodex/tailwindcss-color-modifiers
```
...
```css
@import "tailwindcss";
@plugin "@clodex/tailwindcss-color-modifiers";
```
