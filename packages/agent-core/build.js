...
console.log('Building @clodex/agent-core...');
await esbuild.build({
  entryPoints: {
    index: 'src/index.ts',
    ...
    'services/swarm-orchestrator/index':
      'src/services/swarm-orchestrator/index.ts',
    ...
    'services/memory-notes/index': 'src/services/memory-notes/index.ts',
    'services/evidence-memory/index': 'src/services/evidence-memory/index.ts',
    'services/runner-routing/index': 'src/services/runner-routing/index.ts',
    'services/model-usage/index': 'src/services/model-usage/index.ts',
    'services/model-fabric/index': 'src/services/model-fabric/index.ts',
