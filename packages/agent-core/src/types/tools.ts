...
export const getFileSkeletonToolInputSchema = z.object({
  path: z
    .string()
    .describe(
...
export const sourceSymbolSchema = z.object({
  name: z.string(),
  fullName: z.string(),
  kind: z.string(),
  line: z.number(),
...
export const getFileSkeletonToolOutputSchema = z.object({
  message: z.string(),
  result: z.object({
    path: z.string(),
    language: z.string().optional(),
    totalSymbols: z.number(),
    symbols: z.array(sourceSymbolSchema),
    outline: z.string(),
    truncated: z.boolean(),
...
export type GetFileSkeletonToolInput = z.infer<
  typeof getFileSkeletonToolInputSchema
>;
export type GetFileSkeletonToolOutput = z.infer<
  typeof getFileSkeletonToolOutputSchema
>;

export const getFileSkeletonToolSchema = {
  inputSchema: getFileSkeletonToolInputSchema,
  outputSchema: getFileSkeletonToolOutputSchema,
} as const;

export const getSymbolBodyToolInputSchema = z.object({
  path: z
    .string()
    .describe(
  ...
  symbolName: z
    .string()
    .describe(
      'Symbol name to read, e.g. "handleSubmit", "AuthService.login", or "ChatAgent".',
    ),
});

export const getSymbolBodyToolOutputSchema = z.object({
  message: z.string(),
  result: z.object({
    path: z.string(),
    symbolName: z.string(),
...
export type GetSymbolBodyToolInput = z.infer<
  typeof getSymbolBodyToolInputSchema
>;
export type GetSymbolBodyToolOutput = z.infer<
  typeof getSymbolBodyToolOutputSchema
>;

export const getSymbolBodyToolSchema = {
  inputSchema: getSymbolBodyToolInputSchema,
  outputSchema: getSymbolBodyToolOutputSchema,
} as const;

export const searchProjectSymbolsToolInputSchema = z.object({
  query: z
    .string()
    .min(1)
    .describe(
      'Symbol, class, function, method, interface, variable, or file-related keyword to find across the mounted project.',
    ),
  mount_prefix: z
    .string()
    .optional()
  ...
  max_results: z
    ...
    .max(50)
    .optional()
    .describe('Maximum matches to return. Defaults to 20, maximum is 50.'),
});

export const searchProjectSymbolsToolOutputSchema = z.object({
  message: z.string(),
  result: z.object({
    query: z.string(),
...
export type SearchProjectSymbolsToolInput = z.infer<
  typeof searchProjectSymbolsToolInputSchema
>;
export type SearchProjectSymbolsToolOutput = z.infer<
  typeof searchProjectSymbolsToolOutputSchema
>;

export const searchProjectSymbolsToolSchema = {
...
export const universalToolSchemas = {
  ...
  read: readToolSchema,
  getFileSkeleton: getFileSkeletonToolSchema,
  getSymbolBody: getSymbolBodyToolSchema,
  searchProjectSymbols: searchProjectSymbolsToolSchema,
  ls: lsToolSchema,
...
export type ClodexToolSet<TToolSchemas extends Record<string, any>> = {
