...
2. **`globalskills-sw/*`** — User-level skills from `~/.clodex/skills/`. Personal defaults across all workspaces.
3. **`{WORKSPACE}/.clodex/skills/*`** — Workspace-specific, created for you. Overrides general skills.
