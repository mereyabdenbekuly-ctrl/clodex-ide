...
- File paths: use [](path:{mount-prefixed-path}) markdown links (e.g. [](path:w0123456789abcdef/apps/browser/src/foo.ts)). Convert plain paths from tool annotations to this format. Preserve existing path: links as-is. Legacy wsfile: links from older history should be converted to path: links.
...
- Reference workspace files as [](path:{mount-prefixed-path}) e.g. [](path:w0123456789abcdef/src/foo.ts), not as inline code or plain text.
