...
import type { ChatPersistenceService } from '../chat-persistence';
...
export interface AgentManagerExecutionOptions {
  /**
   * Optional host-owned step executor. Omit to keep the in-process
...
export interface AgentManagerOptions {
  ...
  execution?: AgentManagerExecutionOptions;
