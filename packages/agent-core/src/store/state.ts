...
import type { PendingEditPreview } from '../types/pending-edits';
 ...
 *   `<userData>/clodex/agents/instances.sqlite` (`agentInstances` table);
...
> = {
   ...
   * (`<userData>/clodex/diff-history/data.sqlite`) by
