 ...
 *
 * @param rgBinaryBasePath - Base directory where ripgrep should be stored (e.g., ~/.clodex)
 * @returns Full path to the ripgrep binary
 *
 * @example
 * ```typescript
 * const rgPath = getRipgrepPath('/home/user/.clodex');
 * // Returns: '/home/user/.clodex/bin/rg' on Unix
 * // Returns: 'C:\\Users\\user\\.clodex\\bin\\rg.exe' on Windows
 * ```
 */
