...
[![加入 Discord](https://img.shields.io/discord/1229378372141056010?label=Discord&logo=discord&logoColor=white)](https://discord.gg/c9uGs3cFXr) [![X (前 Twitter) 关注](https://img.shields.io/twitter/follow/clodex_xyz)](https://x.com/clodex_xyz)

![Clodex Agentic IDE 演示](https://raw.githubusercontent.com/clodex/clodex-agentic-ide/main/apps/website/src/app/(home)/_components/feature-images/full-demo-dark.png)

## 关于项目

**Clodex Agentic IDE** 是一款面向开发者的开源 Agentic IDE，内置编程智能体。
...
从 [clodex.xyz](https://clodex.xyz) 下载 Clodex Agentic IDE，并按照简短的新手引导完成账号设置。
...
通过一个 API 密钥接入以下任意订阅，即可在 Clodex Agentic IDE 中解锁该服务商提供的所有模型。
...
### Clodex Agentic IDE 账户

如果想要开箱即用并访问更广泛的模型库，只需创建一个 Clodex Agentic IDE 账户即可。
...
Clodex Agentic IDE 由 Clodex Labs 开发，基于 AGPLv3 许可证发布。

有关许可证模式的更多信息，请访问 [GNU 许可证常见问题解答](https://www.gnu.org/licenses/gpl-faq.html)。

对于超出 AGPLv3 许可范围的使用场景，欢迎[联系我们](mailto:sales@clodex.xyz)。

## 问题反馈

如发现 Bug 或有新想法，欢迎[提交 Issue](https://github.com/clodex/clodex-agentic-ide/issues/new)。

## 社区与支持

- [加入我们的 Discord](https://discord.gg/c9uGs3cFXr)
- 在 [GitHub 上提交 Issue](https://github.com/clodex/clodex-agentic-ide/issues/new) 获取开发支持。
