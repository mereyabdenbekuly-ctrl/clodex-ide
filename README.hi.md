...
[![Discord में शामिल हों](https://img.shields.io/discord/1229378372141056010?label=Discord&logo=discord&logoColor=white)](https://discord.gg/c9uGs3cFXr) [![X (पूर्व Twitter) पर फ़ॉलो करें](https://img.shields.io/twitter/follow/clodex_xyz)](https://x.com/clodex_xyz)

![Clodex Agentic IDE डेमो](https://raw.githubusercontent.com/clodex/clodex-agentic-ide/main/apps/website/src/app/(home)/_components/feature-images/full-demo-dark.png)

## परियोजना के बारे में

**Clodex Agentic IDE** डेवलपर्स के लिए एक ओपन-सोर्स एजेंटिक IDE है जिसमें कोडिंग एजेंट अंतर्निहित है।
...
[clodex.xyz](https://clodex.xyz) से Clodex Agentic IDE डाउनलोड करें और अपना खाता सेट करने के लिए संक्षिप्त ऑनबोर्डिंग गाइड का पालन करें।
...
निम्नलिखित सदस्यताओं में से किसी एक को एक ही API कुंजी के साथ कनेक्ट करें और Clodex Agentic IDE के भीतर सीधे प्रदाता द्वारा प्रस्तुत सभी मॉडल अनलॉक करें।
...
### Clodex Agentic IDE खाता

आसान उपयोग और मॉडलों की एक बड़ी लाइब्रेरी तक तत्काल पहुंच के लिए, बस एक Clodex Agentic IDE खाता बनाएं।
...
Clodex Agentic IDE को Clodex Labs द्वारा विकसित किया गया है और AGPLv3 लाइसेंस के तहत प्रस्तुत किया जाता है।

लाइसेंस मॉडल के बारे में अधिक जानकारी के लिए, [GNU लाइसेंस पर FAQ](https://www.gnu.org/licenses/gpl-faq.html) पर जाएं।

AGPLv3 लाइसेंस द्वारा अनुमत दायरे से बाहर के उपयोग के मामलों के लिए, बेझिझक [हमसे संपर्क करें](mailto:sales@clodex.xyz)।

## समस्याएं

यदि आपको कोई बग मिला है या आपके पास एक नया विचार है, तो बेझिझक [एक इश्यू खोलें](https://github.com/clodex/clodex-agentic-ide/issues/new)।

## समुदाय और सहायता

- [हमारे Discord में शामिल हों](https://discord.gg/c9uGs3cFXr)
- विकास सहायता के लिए [GitHub पर एक इश्यू खोलें](https://github.com/clodex/clodex-agentic-ide/issues/new)।
